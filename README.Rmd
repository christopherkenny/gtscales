...
adding compact legends directly to the table output.
...
scale once, then apply or render it separately.
...
That returns Typst markup generated from the same scale spec used for HTML and
LaTeX rendering.
