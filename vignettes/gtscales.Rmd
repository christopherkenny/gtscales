...
`gtscale_postprocess_docx()` is also available as a fallback if you ever need to repair legend image embeds in a rendered Word document, but it should not be part of the normal Quarto DOCX workflow.
